...
var (
	...
	ExpectedCryptoError   = fmt.Errorf("Password specified, but peer requested an unencrypted connection")
	ExpectedNoCryptoError = fmt.Errorf("No password specificed, but peer requested an encrypted connection")
)
